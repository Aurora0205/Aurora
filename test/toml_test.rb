...
class Aurora::TomlTest < ActiveSupport::TestCase
  ...
  test "nothing" do
    Aurora.execute("test/data/toml/function/nothing_conf.toml")
  ...
  test "same model" do
    Aurora.execute("test/data/toml/function/same_model_conf.toml")
  ...
  test "no autoincrement_id" do
    Aurora.execute("test/data/toml/function/no_autoincrement.toml")
    assert_equal 3, Pref.all.count
  ...
  test "insert setting array" do
    Aurora.execute("test/data/toml/function/array_insert.toml")
    assert_equal 3, Pref.all.count
  ...
  test "insert setting string" do
    Aurora.execute("test/data/toml/function/string_insert.toml")
    assert_equal 3, Pref.all.count
  ...
  test "add_id option" do
    Aurora.execute("test/data/toml/option/add_id_conf.toml")
    assert_equal 3, Pref.all.count
  ...
  test "foreign_key" do
    Aurora.execute("test/data/toml/function/foreign_key_insert.toml")
    assert_equal 3, Pref.all.count
  ...
  test "maked(same model)" do
    ...
    # Aurora.execute("test/data/toml/function/maked/same_model.toml")
    # assert_equal 3, Member.all.count
  ...
  # expected value: registerd escaped str data
  test "optimize" do
    Aurora.execute("test/data/toml/function/optimize.toml")
    assert_equal true, Pref.where(name: "北海道").present?
    assert_equal true, Pref.where(name: "青森県").present?
    assert_equal true, Pref.where(name: "岩手県").present?
  end
